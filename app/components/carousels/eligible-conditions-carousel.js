            ...
            >
                <div className="flex items-start justify-between ml-[calc(2rem_*_-1)]">
                    {props.conditions.condition.map((condition, index) => (
                        ...
                        >
                            <div className="rounded-[20px] border-2 border-[#005371] backdrop-blur-[44px]">
                                <p className="text-3xl font-semibold p-8 text-[#005371] border-b-2 border-[#005371]">
                                    {condition.condition}
                                </p>
                                <p className="p-8 text-base text-[#005371] sm:text-lg font-light">

                ...
                {props.items.map((post, index) => (
                    ...
                    >
                        <div>
                            ...
                            <p className="text-[28px] font-semibold leading-tight mb-8 text-[#005371]">
                                {post.title}
                            </p>
                            <p className="text-[15px] font-light mb-8 text-[#005371]">
                                {post.content_text}
                            </p>
                            {post.url && (
                                <Link
                                    className="uppercase text-[#005371] text-lg tracking-wide font-semibold"
                                    href={post.url}
                                    target="_blank"
                                    title="Read More"
                                >

    ...
    return (
        ...
        >
            ...
            <div className="sm:grid grid-cols-2 gap-4">
                <div className="mb-4 sm:mb-0">
                    ...
                    <div>
                        <input
                            ...
                            type="email"
                            autoComplete="email"
                            className="p-4 rounded-[7px] text-black border-2 border-primary bg-transparent outline-0 w-full font-medium"
                        />
                    </div>
                    {state?.errors?.email && (
                        <p className="text-red-500 text-sm leading-tight mt-2">
                ...
                <div>
                    <label htmlFor="contactNumber" className="text-primary">
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            className="p-4 rounded-[7px] border-2 border-primary text-black bg-transparent outline-0 w-full font-medium"
                        />
                    </div>
                </div>
            </div>
            ...
            <div>
                <label htmlFor="countryCode" className="text-primary">
                ...
                <div>
                    <select
                        ...
                        className="appearance-none p-4 rounded-[7px] border-2 border-primary text-black bg-transparent outline-0 w-full font-medium"
                        required
            ...
            <div>
                <label htmlFor="business" className="cursor-pointer text-primary">
                    <input
                        name="business"
                        id="business"
                        type="checkbox"
                    ...
                    <div>
                        ...
                        <div>
                            <select
                                ...
                                autoComplete="country"
                                className="appearance-none p-4 rounded-[7px] border-2 border-primary font-normal bg-transparent outline-0 w-full font-medium"
                                onChange={(e) =>
            ...
            <div className="flex justify-center">
                <button
                    type="submit"
                    title="UPDATE"
                    className={`py-4 px-6 rounded-full bg-primary shadow border-primary border-2 hover:shadow-[0_0_15px_0px_#005371] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    UPDATE
                    <svg

...
export default function ReferForm(props) {
    ...
    return (
        ...
        >
            ...
            />
            <p className="text-2xl md:text-[28px] font-semibold mb-4 text-primary">
                Personal Details
            </p>
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            className="p-4 rounded-[7px] border-2 text-primary border-primary bg-transparent outline-0 w-full font-medium opacity-50"
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div>
                        <input
                            ...
                            type="date"
                            autoComplete="bday"
                            className="p-4 rounded-[7px] text-primary border-2 border-primary bg-transparent outline-0 w-full font-medium"
                            value={dob}
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <label className="font-normal cursor-pointer text-[13px] sm:text-base text-primary">
                            <input
                                required
                                type="radio"
                                id="gender_male"
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div>
                        <input
                            ...
                            type="email"
                            autoComplete="email"
                            className="p-4 rounded-[7px] text-primary border-2 border-primary bg-transparent outline-0 w-full font-medium opacity-50"
                ...
                <div>
                    <label htmlFor="confirm_email" className="text-primary">
            ...
            <p className="text-2xl md:text-[28px] font-semibold mb-4 mt-4 text-primary">
                Address
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="address1" className="text-primary">
                ...
                <div>
                    <label htmlFor="address2" className="text-primary">Address Line 2</label>
                    <div>
                        <input
                            name="address2"
                            maxLength={50}
            ...
            <div>
                ...
                <div>
                    <input
                        ...
                        className="appearance-none p-4 rounded-[7px] text-primary border-2 border-primary bg-transparent outline-0 w-full font-medium opacity-50"
            ...
            <div>
                <label htmlFor="other_medical_condition" className="text-primary">
                ...
                <div>
                    <input
                        ...
                        type="text"
                        className="p-4 rounded-[7px] border-2 border-primary bg-transparent outline-0 w-full font-medium"
            ...
            <div>
                <label htmlFor="other_medicines_treatments" className="text-primary">
                ...
                <div>
                    <input
                        ...
                        id="other_medicines_treatments"
                        placeholder="Enter other_medicines_treatments"
                        type="text"
                        className="p-4 rounded-[7px] border-2 border-primary bg-transparent outline-0 w-full font-medium"
            ...
            <div>
                <p className="text-2xl md:text-[28px] font-semibold mt-4 mb-2 text-primary">
                    Medical History
                </p>
            ...
            <div>
                <label htmlFor="medicalHistory7Relation" className="text-primary">Relation</label>
                <div>
                    <input
                        maxLength={255}
                        ...
                        type="text"
                        className="p-4 rounded-[7px] border-2 border-primary text-primary bg-transparent outline-0 w-full font-medium"
            ...
            <div>
                <label htmlFor="medicalHistory11" className="text-primary">
            ...
            <div>
                <label htmlFor="medicalHistory15" className="text-primary">
                ...
                <div>
                    <input
                        ...
                        type="text"
                        required
                        className="p-4 text-primary rounded-[7px] border-2 border-primary bg-transparent outline-0 w-full font-medium"
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-4">
                    <label className="font-normal text-primary cursor-pointer text-[13px] sm:text-base">
                        <input
                            required
                            type="radio"
            ...
            <div>
                <label htmlFor="prescriptionsSupplements text-primary">
            ...
            <p className="text-2xl md:text-[28px] font-semibold mt-4 mb-4 text-primary">
                Consent Form
            </p>
            <div
                className="text-sm sm:text-lg p-4 rounded-[7px] border-2 text-primary  border-primary bg-transparent outline-0 w-full font-medium max-h-[400px] overflow-y-scroll consent-form"
            ...
            <div className="flex justify-center items-center gap-4 flex-wrap">
                <button
                    type="submit"
                    title="Save"
                    className={`uppercase py-4 px-6 rounded-full border-primary border-2 bg-primary shadow hover:shadow-[0_0_15px_0px_#005371] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    Save
                    <svg

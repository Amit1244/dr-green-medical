        ...
        <>
            <div className="sm:col-span-2 grid sm:flex gap-2 sm:gap-4 items-center">
                ...
                <div>
                    ...
                    <p className="text-sm sm:text-lg lg:text-2xl text-primary">
            ...
            <div className="text-center flex justify-center">
                <div className="relative">
                    ...
                    <button
                        className="mt-2 text-[10px] text-primary tracking-widest absolute top-full loading-none right-1/2 translate-x-1/2 underline underline-offset-4"
                        title="REMOVE"
